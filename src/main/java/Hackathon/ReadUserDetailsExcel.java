...
public class ReadUserDetailsExcel {
	...
	public static String getExcelPath() {
		...
		String full_path = path + "\\eclipse-workspace\\CalculateTripCost\\Excel_Input\\Holiday_Homes_User_Details.xlsx";
		return full_path;
		...
		for(int i = 0 ; i < sheets; i++){
			...
			if(workbook.getSheetName(i).equalsIgnoreCase(SheetName)) {
		        ...
		        while(cells.hasNext()) {
	                ...
	                {
		        	case NUMERIC:	
		        		//System.out.println(input_value.getNumericCellValue());
